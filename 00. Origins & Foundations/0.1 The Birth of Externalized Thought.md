...
- Al-Khwarizmi {~780-850}
	...
	- His name gave us the word "algorithm"
...
- Astronomical Clocks {14-15th centuries}
	- Intricate geared devices not just for timekeeping but also for predicting celestial events.
...
- Al-Khwarizmi's methods were copied, taught and refined
...
- built in 1642 to help his father {a tax collector}
- Could add and subtract automatically with a system of gears and wheels.
...
##### Gottfried Wilhelm Leibniz {1646-1716}: The visionary
...
- Shannon's work turned information into a measurable, engineerable quantity.
...
- GPU {Graphics Processing Units}
	- Originally for rendering graphics, now central do ML/AI
- ASICs & TPUs {google}
